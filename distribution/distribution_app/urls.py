...
urlpatterns = [
    ...
    path('distribution/work/<int:work_id>/group/<str:group>/', views.DistributionGetView.as_view(),
         name='distribution_get'),
    path('distribution/auto/work/<int:work_id>/group/<str:group>/', views.DistributionAutoView.as_view(),
